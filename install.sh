...
node default {
  ...
  cron {'zanata-sync':
    ...
    command => 'cd /opt/openstack-ansible/playbooks; openstack-ansible os-horizon-install.yml -e "horizon_translations_update=True" --tags "horizon-translations-update',
    user    => 'root',
    minute  => [01,31],
  }
